...
enum class MedicalDeviceInfoType(
    ...
    WIRELESS_PATCH(
        ...
        iconRes = R.drawable.wireless_patch_icon_vector,
        baseColor = Color(0xFFDEA32D),
    ),
    WIRED_PATCH(
        displayNameRes = R.string.device_type_wired_patch,
        iconRes = R.drawable.wired_patch_icon_vector,
    ...
    CONTINUOUS_GLUCOSE_MONITORING_SYSTEM_TRANSMITTER(
        ...
        iconRes = R.drawable.continuous_glucose_monitoring_system_transmitter,
